...
import {
  ...
  BedType,
  OwnershipType,
} from '../core/constants/property.constant';
...
export interface IProperty extends Document {
  ...
  _amenities?: mongoose.Schema.Types.ObjectId[];
  images?: {
    key: string;
    url: string;
  }[];
  ...
  _rules?: mongoose.Schema.Types.ObjectId[];
  ...
  _zoningClassification?: mongoose.Schema.Types.ObjectId;
  availableWeeksPerYear?: number;
  isFurnished?: boolean;
  furnishingDescription?: string;
  ownershipType?: OwnershipType;
  allowsFractionalizationOrEquity?: boolean;
  _propertyFeatures?: mongoose.Schema.Types.ObjectId[];
...
const propertySchema: Schema = new Schema(
  {
    ...
    title: {
      ...
      trim: true,
      maxlength: [
        PROPERTY_VALIDATION.TITLE_MAX_LENGTH,
        `Title cannot exceed ${PROPERTY_VALIDATION.TITLE_MAX_LENGTH} characters`,
      ],
    },
    ...
    description: {
      ...
      trim: true,
      maxlength: [
        PROPERTY_VALIDATION.DESCRIPTION_MAX_LENGTH,
        `Description cannot exceed ${PROPERTY_VALIDATION.DESCRIPTION_MAX_LENGTH} characters`,
      ],
    },
    ...
    maintenanceFee: {
      amount: {
        ...
        required: function (this: IProperty) {
          return (
            this.maintenanceFee && this.maintenanceFee.amount !== undefined
          );
        },
      },
      currency: {
    ...
    bathrooms: {
      type: Number,
      min: [
        PROPERTY_VALIDATION.MIN_BATHROOMS,
        `Minimum ${PROPERTY_VALIDATION.MIN_BATHROOMS} bathrooms required for luxury properties`,
      ],
    },
    ...
    area: {
      value: {
        type: Number,
        min: [
          PROPERTY_VALIDATION.MIN_SQUARE_FOOTAGE,
          `Square footage should be at least ${PROPERTY_VALIDATION.MIN_SQUARE_FOOTAGE} sqft (recommended)`,
        ],
      },
    },
    ...
    propertyValueEstimate: {
      value: {
        type: Number,
        min: [
          PROPERTY_VALIDATION.MIN_HOME_VALUE,
          `Property value should be at least $${PROPERTY_VALIDATION.MIN_HOME_VALUE.toLocaleString()} (recommended)`,
        ],
      },
      currency: {
        type: String,
    ...
    availableWeeksPerYear: {
      type: Number,
      min: [
        PROPERTY_VALIDATION.MIN_AVAILABLE_WEEKS,
        `At least ${PROPERTY_VALIDATION.MIN_AVAILABLE_WEEKS} weeks per year recommended`,
      ],
      max: [
        PROPERTY_VALIDATION.MAX_AVAILABLE_WEEKS,
        `Cannot exceed ${PROPERTY_VALIDATION.MAX_AVAILABLE_WEEKS} weeks per year`,
      ],
    },
    ...
    furnishingDescription: {
      ...
      trim: true,
      maxlength: [
        PROPERTY_VALIDATION.FURNISHING_DESCRIPTION_MAX_LENGTH,
        `Furnishing description cannot exceed ${PROPERTY_VALIDATION.FURNISHING_DESCRIPTION_MAX_LENGTH} characters`,
      ],
    },
    ...
    conciergeServicesIncluded: {
      ...
      trim: true,
      maxlength: [
        PROPERTY_VALIDATION.CONCIERGE_SERVICES_MAX_LENGTH,
        `Concierge services description cannot exceed ${PROPERTY_VALIDATION.CONCIERGE_SERVICES_MAX_LENGTH} characters`,
      ],
    },
      ...
      checkIn: {
        ...
        validate: {
          validator: function (value: string) {
            ...
            return /^(1[0-2]|0?[1-9]):([0-5][0-9]) (AM|PM)$|^([01]?[0-9]|2[0-3]):([0-5][0-9])$/.test(
              value
            );
          },
    ...
    localHighlights: {
      ...
      trim: true,
      maxlength: [
        PROPERTY_VALIDATION.LOCAL_HIGHLIGHTS_MAX_LENGTH,
        `Local highlights cannot exceed ${PROPERTY_VALIDATION.LOCAL_HIGHLIGHTS_MAX_LENGTH} characters`,
      ],
    },
...
// Export the constants and types for backward compatibility
export {
  PROPERTY_TYPES,
  PROPERTY_STATUS,
  BLOCKCHAIN_STATUS,
